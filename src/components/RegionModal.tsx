          ...
          >
            ...
            <div className="flex-1 overflow-y-auto bg-white/65 p-4 sm:p-6 custom-scrollbar">
              <div className="mb-4 flex items-center justify-between px-1">
                <p className="text-xs font-black tracking-wide text-slate-500">目前可選擇的區域</p>
                <span className="rounded-full bg-emerald-100 px-2.5 py-1 text-[10px] font-black text-emerald-700">{ALL_REGIONS.filter((region) => region.active).length} 個區域已開放</span>
              </div>
