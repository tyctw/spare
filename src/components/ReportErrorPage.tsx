...
import { AlertCircle, ArrowLeft, ArrowRight, Check, CheckCircle2, ClipboardList, FileWarning, Home, Link as LinkIcon, Loader2, Mail, Plus, Send, ShieldCheck, Sparkles } from 'lucide-react';
...
export default function ReportErrorPage() {
  ...
  if (submitted) return (
    <main className="min-h-screen overflow-x-hidden bg-[#f8fafc] text-slate-900"><section className="relative overflow-hidden border-b-4 border-slate-900 bg-emerald-300"><div aria-hidden="true" className="absolute -right-12 -top-20 h-80 w-80 rounded-full border-[38px] border-white/45" /><div aria-hidden="true" className="absolute right-[28%] top-16 h-5 w-5 rounded-full bg-amber-300" />
