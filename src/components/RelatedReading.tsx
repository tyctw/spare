...
export default function RelatedReading({ path }: { path: string }) {
  ...
  return <section className="mx-auto max-w-[90rem] px-4 pb-12 sm:px-6 lg:px-8 xl:px-10" aria-labelledby="related-reading-title">
    <div className="relative overflow-hidden rounded-[2rem] border-4 border-slate-900 bg-[linear-gradient(135deg,#fffbeb_0%,#ffffff_48%,#eef2ff_100%)] p-5 text-slate-900 shadow-[3px_3px_0_#0f172a] sm:p-7 lg:p-9">
