                ...
                <div className="order-2 rounded-[2rem] bg-slate-100 p-4">
                  ...
                  <div className="mt-3 divide-y-4 divide-slate-100 overflow-hidden rounded-[1.7rem] bg-white/75">
                    ...
                    <div className="grid grid-cols-2 divide-x-2 divide-slate-100 bg-slate-50/70">
                      <a href="https://www.instagram.com/exam.tw/" target="_blank" rel="noreferrer" className="group flex items-center justify-center gap-2 px-3 py-3 text-xs font-black text-slate-600 transition hover:bg-white hover:text-pink-600" aria-label="前往 Instagram，新分頁開啟"><Instagram className="h-4 w-4" />Instagram<ArrowRight className="h-3.5 w-3.5 transition-transform group-hover:translate-x-0.5" /></a>
                      <a href="https://www.threads.com/@exam.tw" target="_blank" rel="noreferrer" className="group flex items-center justify-center gap-2 px-3 py-3 text-xs font-black text-slate-600 transition hover:bg-white hover:text-slate-900" aria-label="前往 Threads，新分頁開啟"><ThreadsIcon className="h-4 w-4" />Threads<ArrowRight className="h-3.5 w-3.5 transition-transform group-hover:translate-x-0.5" /></a>
                    </div>
