  ...
  return <footer className="mt-16 border-t-4 border-slate-900 bg-slate-50 px-4 py-8 sm:px-6 lg:px-8">
    <div className="mx-auto max-w-7xl overflow-hidden rounded-3xl border-4 border-slate-900 bg-white shadow-[6px_6px_0_#0f172a]">
      <div className="grid gap-7 p-6 sm:p-8 lg:grid-cols-[1.2fr_.8fr] lg:items-center">
        ...
        <section className="rounded-2xl border-2 border-slate-900 bg-indigo-50 p-5"><div className="flex items-start gap-3"><div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border-2 border-slate-900 bg-white text-indigo-700 shadow-[2px_2px_0_#0f172a]"><Mail className="h-5 w-5" /></div><div><p className="text-sm font-black text-slate-900">需要協助嗎？</p><p className="mt-1 text-sm font-bold leading-6 text-slate-600">有使用問題、資料建議或合作需求，歡迎直接來信。</p></div></div><a href="mailto:tyctw.analyze@gmail.com" className="group mt-4 flex items-center justify-between gap-3 rounded-xl border-2 border-slate-900 bg-white px-4 py-3 text-indigo-700 shadow-[3px_3px_0_#0f172a] transition hover:-translate-y-0.5 hover:shadow-[4px_4px_0_#0f172a] active:translate-y-0 active:shadow-none"><span className="min-w-0 break-all text-sm font-black">tyctw.analyze@gmail.com</span><ArrowRight className="h-4 w-4 shrink-0 transition group-hover:translate-x-1" /></a></section>
      </div>
