...
export const AREA_DATA: AreaData[] = [
  ...
  },
  {
    ...
    cities: '嘉義市、嘉義縣',
    active: false,
    description: '嘉義區涵蓋嘉義市與嘉義縣，區內學校類型多元，兼具普通型高中與技術型高中。考生可依會考成績與興趣探索適合的升學方向。嘉義區落點分析功能正在籌備中。',
    keywords: ['嘉義區會考落點分析', '嘉義區志願選填', '嘉義會考落點', '嘉義高中落點', '嘉義區高中錄取分數', '嘉義高中職落點'],
    faqs: [
      { q: '嘉義區會考落點分析什麼時候開放？', a: '嘉義區的落點分析資料正在整理中，開放後將第一時間更新。建議先使用興趣測驗與志願策略進行前期規劃。' },
      { q: '嘉義區涵蓋哪些縣市？', a: '嘉義區涵蓋嘉義市與嘉義縣，兩地學生皆可報名嘉義區免試入學。' },
      { q: '嘉義區有哪些學校類型？', a: '嘉義區內設有普通型高中、技術型高中與五專等學制，考生可依個人興趣與生涯方向選擇適合的學校類型。' },
      { q: '等待嘉義區落點分析開放期間，有什麼替代工具？', a: '可先使用本站的 Holland 興趣測驗探索適合職群方向、以志願選填策略頁了解選填原則，並在落點分析開放後搭配使用。' },
    ],
  },
  {
    slug: 'tainan',
