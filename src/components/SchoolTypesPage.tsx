  ...
  return (
    <main className="min-h-screen overflow-x-clip bg-slate-50 text-slate-900">
      ...
      <section className="mx-auto grid max-w-6xl gap-6 px-4 py-8 sm:gap-8 sm:px-6 sm:py-10 lg:grid-cols-[240px_1fr] lg:px-8">
        <aside className={pageNavigationAsideClassName}><PageNavigation navClassName="w-full rounded-2xl border-4 border-slate-900 bg-white p-3 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] sm:p-4" itemLayoutClassName="grid gap-2 lg:block lg:space-y-2" items={[{ id: 'overview', label: '五種學校類型', className: 'text-center lg:block lg:text-left' }, { id: 'comparison', label: '快速比較', className: 'text-center lg:block lg:text-left' }, { id: 'choose', label: '選校前檢查', className: 'text-center lg:block lg:text-left' }, { id: 'sources', label: '官方資料與提醒', className: 'text-center lg:block lg:text-left' }]} /></aside>
