...
const REGION_SCORING_DATA: Record<string, {
  ...
  kaohsiung: {
    total: '100',
    items: [
      { label: '志願序', score: '30', desc: '第1志願群30分，第2志願群29分，第3志願群28分 (每志願群可填10校，連續選填同校不同科計為同一志願)' },
      { label: '多元發展', score: '40', desc: '均衡學習上限10分、服務學習上限10分(滿3小時1分/學年上限4分)、體適能上限20分、競賽表現上限20分、檢定證照上限20分、獎勵紀錄上限10分(大功4.5/小功1.5/嘉/0.5)、幹部任期上限10分' },
      { label: '國中教育會考', score: '30', desc: '五科轉換積分：達精熟者每科6分、達基礎者每科4分、待加強者每科2分' }
    ],
    examDetail: [
      { level: 'A++', score: '6分 (7點)' },
    ...
    note: '會考總計滿分30分，標示點數滿點35點。同時獲得多元發展項目各細項分數時，依規定擇一計分不重複。'
  },
  hsinchu: {
    total: '100',
    items: [
