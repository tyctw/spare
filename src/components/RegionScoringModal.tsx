...
export const REGION_SCORING_DATA: Record<string, {
  ...
  central: {
    total: '100',
    items: [
      { label: '志願序', score: '30', desc: '第1至10個志願序30分，第11至20個志願序29分，第21個志願序以後28分；連續選填同校不同類科計為同一志願序' },
      { label: '就近入學', score: '10', desc: '符合中投區免試就學區或共同就學區者10分' },
      { label: '扶助弱勢', score: '3', desc: '偏遠地區、中低收入戶、低收入戶依簡章規定採計，上限3分' },
      { label: '多元學習表現', score: '27', desc: '含均衡學習、德行表現、無記過紀錄、獎勵紀錄等' },
  ...
  tainan: {
    total: '108',
    items: [
      { label: '志願序', score: '12', desc: '第一志願序12分、第二11分、第三10分、第四9分、第五8分，第六志願序(含)後7分；每一志願序至多可選填3校為一群組' },
      ...
      { label: '國中教育會考', score: '36', desc: '五科與寫作測驗依臺南區115學年度簡章採計，國中教育會考積分最高36分' }
    ],
    examDetail: [
