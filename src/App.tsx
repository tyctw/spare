            ...
            >
              ...
              <div className="flex flex-col gap-3 sm:gap-4">
                {[
                  ...
                  <div key={subject.id} className="relative group bg-white border-2 border-slate-900 rounded-2xl p-3 sm:p-4 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_rgba(15,23,42,1)] transition-all flex flex-col gap-2 sm:gap-3">
                    <div className="shrink-0 text-sm sm:text-lg font-black text-slate-700 flex items-center justify-start gap-2">
                      <div className="w-6 h-6 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl border-2 border-slate-900 flex items-center justify-center shrink-0 shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] bg-slate-50">
                        <subject.icon className={`w-3 h-3 sm:w-5 sm:h-5 ${subject.color}`} />
                      </div>
                      {subject.label}
                    </div>
                    <div className="flex w-full overflow-hidden border-2 border-slate-900 rounded-lg sm:rounded-xl shadow-[2px_2px_0px_0px_rgba(15,23,42,1)]">
                      {['A++', 'A+', 'A', 'B++', 'B+', 'B', 'C'].map(val => (
                        <button
                          key={val}
                          onClick={() => updateForm(subject.id, val)}
                          className={`flex-1 py-1.5 sm:py-2 text-[10px] sm:text-sm font-black border-r-2 border-slate-900 last:border-r-0 transition-colors ${
                ...
                {/* Composition */}
                <div className="relative group bg-slate-900 border-2 border-slate-900 rounded-2xl p-3 sm:p-4 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_rgba(15,23,42,1)] transition-all flex flex-col gap-2 sm:gap-3">
                  <div className="shrink-0 text-sm sm:text-lg font-black text-slate-100 flex items-center justify-start gap-2">
                    <div className="w-6 h-6 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl border-2 border-amber-400/50 flex items-center justify-center shrink-0 shadow-[2px_2px_0px_0px_rgba(251,191,36,0.2)] bg-slate-800">
                      <PenTool className="w-3 h-3 sm:w-5 sm:h-5 text-amber-400" />
                    </div>
                    寫作
                  </div>
                  <div className="flex w-full overflow-hidden border-2 border-slate-700 rounded-lg sm:rounded-xl shadow-[2px_2px_0px_0px_rgba(0,0,0,0.5)]">
